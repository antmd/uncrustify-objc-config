...
#!/bin/bash
"/Users/ant/Development/Applications/UniversalIndentGUI_macx/indenters/uncrustify" -f "$file2indent" -c "./call_Uncrustify.cfg" -o indentoutput.tmp
...
#!/bin/bash
"/Users/ant/Development/Applications/UniversalIndentGUI_macx/indenters/uncrustify" -f "$1" -c "./call_Uncrustify.cfg" -o indentoutput.tmp
